...
namespace ProjectManager.Gateway
{
    public class AutofacRegistrationHelper : IRegistrationHelper
    {
        ...
        /// <param name="endPointCollectionName"></param>
        private void RegisterEndPointCollection(Type serviceInterface, string endPointCollectionName)
        {
            ...
            if (epc == null)
                throw new Exception($"An EndPointCollection named {endPointCollectionName} was not found.  Call the RegisterEndPoints method before calling RegisterService with an EndPointCollection name. Also check your spelling.");
